...
export const FoodDonationProvider = ({ children }) => {
  ...
  const getDonorDetails = useCallback(async () => {
    try {
      ...
      const response = await axios.get(
        "https://nourishnet-backend-tau.vercel.app/donor/details",
        {
  ...
  const getUserDonations = async () => {
    try {
      const response = await axios.get(
        `https://nourishnet-backend-tau.vercel.app/donor/donations/${donorData._id}`,
      );
  ...
  const getDonationsDetails = async (id) => {
    try {
      const response = await axios.get(
        `https://nourishnet-backend-tau.vercel.app/donation/${id}`,
      );
